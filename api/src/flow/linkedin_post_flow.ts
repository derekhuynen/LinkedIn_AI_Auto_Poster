...
export interface LinkedInPostFlowOptions {
	...
	persist: boolean;
	/** Run image generation (and the image prompt step). */
	generateImage: boolean;
}

/**
 * Orchestrates the workflow for generating and posting a LinkedIn post using Azure OpenAI, Blob Storage, and Cosmos DB.
...
export async function linkedInPostFlow(
	...
	try {
		...
		// Step 3: Generate cover image (gpt-image-1)
